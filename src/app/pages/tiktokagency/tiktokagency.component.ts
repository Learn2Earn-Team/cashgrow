...
@Component({
  selector: 'app-tiktokagency',
  templateUrl: './tiktokagency.component.html',
  styleUrls: ['./tiktokagency.component.scss']
})
export class TiktokagencyComponent implements OnInit{
  public name = 'TikTok'
  public TikTokData: any[] = [];
