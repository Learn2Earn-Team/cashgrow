...
@Component({
  selector: 'app-userpostview',
  templateUrl: './userpostview.component.html',
  styleUrls: ['./userpostview.component.scss']
})
export class UserpostviewComponent implements OnInit, AfterViewInit{
...
public commentsdData: any = {username:'', text:'', postid:''}
 ...
 ngOnInit(): void {
  ...
  // }
    ...
    //  await this.apicall.api_getTeam(userData.username).subscribe(async teams=>{
    //     console.log(teams)
