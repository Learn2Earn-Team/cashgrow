...
@Component({
  selector: 'app-youtubeagency',
  templateUrl: './youtubeagency.component.html',
  styleUrls: ['./youtubeagency.component.scss'],
})
export class YoutubeagencyComponent implements OnInit{
  public name = 'Youtube';
