...
export class ComplainComponent implements OnInit, AfterViewInit, AfterViewChecked{
  ...
  async addComplain() {
    ...
    if(userData.username == 'google') {
      ...
      this.apicall.api_addComplain(this.userMessage).subscribe(res=>{
        console.log(res)
        this.getComplain(this.stateData.username);
        this.userMessage = { sender: this.stateData.username, message:'', reciver:'', reply:''}
        this.message = '';
        this.scrollToBottom();
      })
    }
      ...
      this.apicall.api_addComplain(this.userMessage).subscribe(res=>{
        console.log(res)
        this.getComplain(userData.username);
        this.userMessage = { sender: userData.username, message:'', reciver:'', reply:''}
        this.message = '';
        this.scrollToBottom();
      })
    }
